%This code returns inverse 2D DCT matrix performing
%row after column wise inverse 1D DCT operation of a block of size N*N pixel 
%
%
%
%

function [dct2d_mat_ablk]=dct2d_inv_ablk(new_blk,blk_size)
try
    %new_blk=blks{k1,k2}
